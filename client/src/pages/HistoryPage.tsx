...
export default function HistoryPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#c8d5e0" }}>
      ...
      <SimplePageHeader
        heading="History of Ulkatcho First Nation"
        breadcrumbs={[
          { label: "Home", href: "/" },
      ...
      <div className="container py-14">
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-14 scroll-reveal">
            ...
            <p className="mb-4 leading-relaxed" style={{ fontFamily: "Lora, serif", color: "#333", fontSize: "1rem" }}>
              One of the dominant features around Anahim Lake is Besbut'a or Anahim Peak. In the Ulkatcho Dakelh dialect it means "obsidian mountain".
            </p>
            <p className="mb-4 leading-relaxed" style={{ fontFamily: "Lora, serif", color: "#333", fontSize: "1rem" }}>

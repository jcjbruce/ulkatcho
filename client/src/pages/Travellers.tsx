      ...
      <div className="container py-14">
        <div className="max-w-3xl mx-auto" style={{ fontFamily: "Lora, serif", color: "#333", fontSize: "1rem", lineHeight: "1.8" }}>
          ...
          <section className="scroll-reveal">
            ...
            {get("section_3.body").split("\n\n").filter(Boolean).slice(0, 1).map((p, i) => (
              <p key={i} className="mb-5">{p}</p>
            ))}
            ...
            {get("section_3.body").split("\n\n").filter(Boolean).slice(1).map((p, i) => (
              <p key={i} className="mb-5">{p}</p>
            ))}
          </section>
